import './App.css';
import {Button,Container,Row,Col,Navbar,Nav,Carousel,Accordion,Table,iframe} from 'react-bootstrap';
        ...
        <Container>
          ...
          <Row>
            ...
            <Col>
              ...
              <Col>
              <Button  onClick={()=>mint()} variant={address?"danger":"secondary"}>Mint My NFT</Button>
            </Col>
